...
channel7 = Channel.create(name: "moms", description: "The real heroes")
channel8 = Channel.create(name: "supervillains", description: "Because Attack doesn't discriminate")
...
subscription20 = Suscription.create(user_id: user12.id, channel_id: channel8.id)
subscription21 = Suscription.create(user_id: user13.id, channel_id: channel8.id)
subscription22 = Suscription.create(user_id: user14.id, channel_id: channel8.id)
subscription23 = Suscription.create(user_id: user15.id, channel_id: channel8.id)
